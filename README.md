...
> | Investment | 115 | 22 | 1 |
<br>
In terms of the distirbution of labeled confidence level, the 'Summary for Policymakers' section has the highest count of high confidence labels - consistent with the section's role, which is to provide a concise summary of the report's key findings and recommandations, tailored for policymakers. The mitigation section, discussing about potential emission reduction pathways (climate scenarios), and the energy section, discussing about energy sources, consumptions, and development, are the second and third highest count of high confidence labels. In contrast, the AFLOU section stands out with the most occureences of low confidence labels. The observation indicates that statements necessitating collaborative from diverse stakeholders and predicting the future impacts of possible change tends to receive lower confidence level, where as those substantiated with scientific and empirical evidence derived from IPCC's climate models and data receive higher confidence label. This is in line with the IPCC's rigorous evaluation process, which seeks to ensure that statements are backed by reliable scientific evidence and consensus among experts. <br>
<br>
...
<br>
All sections receive an overall score of 1 indicating that the IPCC's report is written in an extremely positive tone. Comparing the scores across the confidence level, the scores for high confidence are generally higher and are all nearly equal to 1 (the most positive tone) with the exception of the building section. For the building section, one possible reason for the low sentiment score is due to vocabularies to express low evidence in the statement and the content itself concerning about the damage of inaction. For insatnce, the chapter stated 'Repurposing existing non-residential buildings, no longer in use due to the expected spread of teleworking triggered by the health crisis and enabled by digitalisation, could be the way to overcome the new needs for officetelschool buildings triggered by the health crisis (low evidence, high confidence)'. Words like 'trigger', 'crisis', and'low' can result the negative score for the text. <br>
<br>
...
### **TF-DIF Test**
The chart below provides the top five words mentioned with high, medium, and low confidence levels in different sections, excluding interfering words. The interfering words here defined as any works that does not provide specific information for the given chapter. This is a manual revising process to select the top 5 words with the most mentions by confidence level. Digits, units, overarching terms (e.g words like climate, change, confidence, and 'year' that does not provide detailed information for audience to understand the content of the reports). Therefore, the following chart might be biased depending on the audience group. In this study, we are primarily interested in understanding the linguistic tones for the mitigation pathways and technology.
...
<br>
From the chart, the energy systems, AFLOU, and migitation sections all have the word, 'emission', as one of the most frequently mentioned. "Carbon" is another commonly mentioned word across several sections such as Energy Systems, AFLOU, Mitigation, and Transport sections. "Mitigation" itself is a frequently mentioned word in both the Mitigation and AFLOU sections. <br>
<br>
Some important takeaways from the TF-IDF test are:<br>
1. statements with high confidence labels for the industry section cover 'materials', 'efficiency', and 'use'. The section emphasises on the energy emission intensive and basic material industrys as key strategies reaching net zero emissions. It highlight the importance of materials and energy efficiency' in emission reduction, to the IPCC's view;<br>
2. 'Aviation' is the most freuqently mentioned word among statements with low confidence label for the transport sector. It reflects the diversified discussions on the decarbonization strategies for the aviation sector. In contrast, 'hydrogen', 'fuel', and 'electric' are frequently mentioned in the high-confident statements. This not hard to infer that IPCC's position to decarbonize the transport sector through fuel transitions (from carbon-intensive sources to renewables)<br>
3. 'economic' is one of the most frequently mentioned in the low-confidence statements from the migitation sector indicating the IPCC's concerns and uncertainty towards the economic impact of different mitigation strategies.<br>